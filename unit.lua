...
NeP.FakeUnits:Add("highestenemy", function(num)
	...
	for _, Obj in pairs(NeP.OM:Get("Enemy")) do
		if _G.UnitExists(Obj.key) and _G.UnitIsVisible(Obj.key) and NeP.DSL:Get("combat")(Obj.key) and NeP.DSL:Get("alive")(Obj.key) and not NeP.DSL:Get("player")(Obj.key) and not NeP.DSL:Get("pvp")(Obj.key) then
